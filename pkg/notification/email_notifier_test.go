...
func TestEmailNotifier_Send(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Contains(t, msgStr, tt.message.Event.SiteURL)
			assert.Contains(t, msgStr, tt.message.Event.Status)
			assert.Contains(t, msgStr, tt.message.Event.Message)
			assert.Contains(t, msgStr, tt.message.Event.OccurredAt.String())
		})
	}
}
